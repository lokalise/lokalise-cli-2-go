...
```
      ...
      --directory-prefix string                 Directory prefix in the bundle, used when original_filenames set to true). Allowed placeholder is %LANG_ISO%. (default "defaultDirectoryPrefix")
