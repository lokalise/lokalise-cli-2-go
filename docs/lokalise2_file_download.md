...
```
      ...
      --directory-prefix string                 Directory prefix in the bundle, used when original_filenames set to true). Allowed placeholder is %LANG_ISO%.
      --disable-references                      Enable to skip automatic replace of key reference placeholders (e.g. [%key:hello_world%]) with their corresponding translations.
  ...
  -h, --help                                    help for download
      ...
      --include-description                     Enable to include key description in exported file (if supported by the format).
