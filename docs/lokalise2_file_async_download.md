## lokalise2 async file download

Download files in async mode

### Synopsis

Exports project files as a .zip bundle. Generated bundle will be available to download for next 24 hours from returned URL. As the bundle is generated and uploaded you would get a response with the URL to the file. Requires Download files admin right.

```
lokalise2 file async-download [flags]
```
